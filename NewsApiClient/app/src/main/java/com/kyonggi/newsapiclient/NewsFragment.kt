...
import com.kyonggi.newsapiclient.databinding.FragmentNewsBinding
...
class NewsFragment : Fragment() {
            ...
            when (response) {
                ...
                is Resource.Error -> {
                    ...
                    response.message?.let {
                        Toast.makeText(activity, "에러 발생 : $it", Toast.LENGTH_SHORT).show()
                    }
                }
                is Resource.Loading -> {
                    showProgressBar()
    ...
    private fun setSearchView() {
        fragmentNewsBinding.searchview.setOnQueryTextListener(object :
